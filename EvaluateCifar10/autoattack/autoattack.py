...
class AutoAttack():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if not self.is_tf_model:
            ...
            self.apgd_targeted = APGDAttack_targeted(self.model, n_restarts=5, n_iter=100, verbose=False,
    ...
    def run_standard_evaluation(self,
        ...
        attacks_to_run = self.attacks_to_run
     #   attacks_to_run = list(('apgd-ce','apgd-dlr','fab','square'))
        if self.verbose:
